...
public interface ClassesBlock {
    ...
    /*
    Пускай время городских переговоров превышает заданное больше 60! (Радик)
    ...
    /*
      ...
      Товаровед регистрTaskCollectionирует Продажу и может занести неплательщика в «черный список».
     */
}
